...
namespace AI_SeriesHOL.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<JsonResult> RegisterAPI(string data, string check)
        {
        ...
        //Face Register API
        public async Task<JsonResult> FaceRegisterAPI(string data, string name, string gender, string phone, string email)
        {
            var imagebyte = Facade.storetoserver(data);
        ...
        //Verify API
        public async Task<JsonResult> VerifyAPI(string data, string check, string random_gesture)
        {
            var imagebyte = Facade.storetoserver(data);
            string imgefile = "Img" + $@"{System.DateTime.Now.Ticks}.jpg";
            string Url = Server.MapPath(@"~\Images\" + imgefile);
            ...
            List<List<string>> result = Facade.User_Verification(imgefile, imagebyte, random_gesture, check);
        ...
        //Random Gesture API
        public async Task<JsonResult> RandomGestureAPI()
        {
