                ...
                namespace FaceAPI
                {
                    public class DocumentVerificationHandler
                    {
                        ...
                        public async Task GetTextAsync(ComputerVisionClient computerVision, string operationLocation)
                        {
                            ...
                            {
                                //Calling LUIS
                                var client = new RestClient("https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/e569a3f6-4254-4060-a326-3a6372d0b419?verbose=true&timezoneOffset=-360&subscription-key=76e8996cfd994ef3a4b79b938c0c2b04&q=" + OCRList[j]);
